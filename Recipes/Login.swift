...
UITextFieldDelegate
{
    ...
    @IBOutlet var forgotPasswrdBtn: UIButton!
...
//    mainView.layer.cornerRadius = 21
  //  mainView.layer.shadowOpacity = 1
   ...
   // mainView.layer.shadowColor = UIColor(red: 128.0/255, green: 128.0/255, blue: 128.0/255, alpha: 1.0).cgColor
    ...
    forgotPasswrdBtn.layer.shadowRadius = 5.0
    forgotPasswrdBtn.layer.shadowOffset = CGSize(width: 0.0, height: 4.0)
    forgotPasswrdBtn.layer.masksToBounds = false
    forgotPasswrdBtn.layer.shadowPath = UIBezierPath(roundedRect: forgotPasswrdBtn.bounds, cornerRadius: forgotPasswrdBtn.layer.cornerRadius).cgPath
    forgotPasswrdBtn.layer.shadowColor = UIColor(red: 128.0/255, green: 128.0/255, blue: 128.0/255, alpha: 1.0).cgColor
    // Setup layouts
